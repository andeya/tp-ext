...
[ignore-case](https://github.com/henrylee2cn/tp-ext/blob/master/plugin-ignore-case)|`import ignoreCase "github.com/henrylee2cn/tp-ext/plugin-ignore-case"`|Dynamically ignoring the case of path
